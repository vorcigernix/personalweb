            ...
            <div class="flex flex-col sm:flex-row mt-10  bg-gradient-to-b from-[#1e3b8ac5] to-[#1e3b8a3f] text-[#fff] backdrop-blur-lg border-[1px] border-solid border-white border-opacity-20 rounded-2xl shadow-[rgba(0,0,0,0.70)] shadow-2xl">
              ...
              <div class="sm:w-2/3 sm:px-8 px-4 sm:py-8 py-4 sm:border-l border-solid border-white border-opacity-20  mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                <p class="leading-normal mt-3 mb-4">
                  I'm a seasoned leader dedicated to enhancing and scaling
                  product development organizations. With over a decade of
                  experience, I've cultivated a startup mindset while
                  streamlining processes for larger enterprises. Currently, I
                  serve as the CTO at Smartsupp, driving innovation in chatbot
                  solutions.
                </p>
                <Mint
                        ...
                        <div class="-my-8 divide-y-1 divide-[rgba(255,255,255,0.5)]">
                          <div class="py-8 flex flex-wrap md:flex-nowrap">
                            ...
                            <div class="md:flex-grow">
                              ...
                              <p class="leading-normal mt-3">
                                Working with the rest of the leadership on
                                strategic planning and translating the strategy
                                into technology improvements.
                              </p>
                              <p class="leading-normal mt-3">
                                Helping align self-organized teams with company
                                objectives while fostering cross-team
                                collaboration.
                              </p>
                              <p class="leading-normal mt-3">
                                Mentoring developers in various areas to enhance
                                their skills and contributions.
                              </p>
                              <p class="leading-normal mt-3">
                                Facilitating essential meetings to ensure
                                effective communication and decision-making.
                              </p>
                              <p class="leading-normal mt-3">
                                Driving innovation through the introduction of
                                new methodologies and creative problem-solving
                                approaches.
                              </p>
                              <a
                          ...
                          <div class="py-8 flex border-t-2 border-gray-800 flex-wrap md:flex-nowrap">
                            ...
                            <div class="md:flex-grow">
                              ...
                              <p class="leading-normal mt-3">
                                Built the whole system that allow content
                                creation with a friendly UI.
                              </p>
                              <p class="leading-normal mt-3">
                                This CMS publish all the content to the user
                                owned IPFS decentralized network.
                              </p>
                              <a
                                class="text-[#bae6fd] hover:text-[#0ea5e9] inline-flex items-center mt-4 border-0 focus:outline-none transition-colors duration-500"
                                href="https://blockenberg.xyz/"
                                alt="Blockenberg, the unstoppable CMS"
                              >
                                Learn More
                                <svg
                                  class="w-4 h-4 ml-2"
                          ...
                          <div class="py-8 flex border-t-2 border-gray-800 flex-wrap md:flex-nowrap">
                            ...
                            <div class="md:flex-grow">
                              ...
                              <p class="leading-normal mt-3">
                                Spearheaded the successful merger of engineering
                                departments from four different companies.
                              </p>
                              <p class="leading-normal mt-3">
                                Pioneered the establishment of core engineering
                                processes to streamline operations and boost
                                efficiency.
                              </p>
                              <p class="leading-normal mt-3">
                                Took personal leadership in critical integration
                          ...
                          <div class="py-8 flex border-t-2 border-gray-800 flex-wrap md:flex-nowrap">
                            ...
                            <div class="md:flex-grow">
                              ...
                              <p class="leading-normal mt-3">
                                Designed and implemented a comprehensive career
                                development plan to nurture talent within the
                                organization.
                              </p>
                              <p class="leading-normal mt-3">
                                Developed and refined the planning process,
                                optimizing it for better efficiency and
                                outcomes.
                              </p>
                              <p class="leading-normal mt-3">
                                Successfully restructured the engineering
                                department using the value stream model to
                                enhance productivity and alignment with business
                                goals.
                              </p>
                              <p class="leading-normal mt-3">
                                Improved the process for developers to
                                contribute effectively to product discovery,
                                resulting in more innovative and valuable
                                solutions.
                              </p>
                              <p class="leading-normal mt-3">
                                Established a horizontal (tech-stack oriented)
                                guild system, fostering collaboration and
                          ...
                          <div class="py-8 flex border-t-2 border-gray-800 flex-wrap md:flex-nowrap">
                            ...
                            <div class="md:flex-grow">
                              ...
                              <p class="leading-normal mt-3">
                                Designed and executed a comprehensive operations
                                management strategy to optimize organizational
                                efficiency.
                              </p>
                              <p class="leading-normal mt-3">
                                Played a key role as part of the Innovation
                                Team, contributing to innovative solutions and
                                initiatives.
                              </p>
                              <p class="leading-normal mt-3">
                                Developed and successfully implemented an Agile
                                budgeting system, enhancing financial planning
